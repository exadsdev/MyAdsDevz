...
/** แปลง thumbnail ที่เป็น full URL -> path */
...
/** แปลง thumbnail ใน state/JSON ให้กลายเป็น URL จริงสำหรับแสดงผล */
              ...
              {thumbMode === "file" && (
                ...
                >
                  ...
                  <div className="small text-muted mb-2">
                    ลากไฟล์มาวางได้ หรือกดเลือกไฟล์ (สูงสุด ~5MB)
                  </div>
                  <button
                    type="button"
                  ...
                  {form.thumbnail && (
                    <div className="small mt-2">
                      Path/URL ที่บันทึกไว้:{" "}
                      <code>{form.thumbnail}</code>
                    </div>
                  )}
                </div>
              )}
