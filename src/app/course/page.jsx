...
const OG_IMAGE = `${SITE_URL}/images/cass.webp`;
...
export default function CoursesPage() {
  ...
  // === JSON-LD: Product (คอร์ส Facebook) ===
  const facebookCourseLd = {
    "@context": "https://schema.org/",
    "@type": "Product",
    name: "คอร์สเรียนโฆษณา Facebook/Meta Ads",
    image: [`${SITE_URL}/images/facebook_ads.webp`],
  ...
  // === JSON-LD: Product (คอร์ส Google) ===
  const googleCourseLd = {
    "@context": "https://schema.org/",
    "@type": "Product",
  ...
  return (
    <>
      ...
      <JsonLd json={facebookCourseLd} />
      <JsonLd json={googleCourseLd} />
      ...
      <div className="container-fluid py-5">
        ...
        <div className="text-center mb-5">
          <h1 className="mb-4 fw-bold">คอร์สเรียนโฆษณาออนไลน์</h1>
          <Image
        ...
        <div className="d-flex justify-content-center gap-3 mb-5 flex-wrap">
          <Link href="/course/facebook" className="btn btn-outline-primary btn-lg">
            คอร์สเรียน Facebook/Meta Ads
          </Link>
          <Link href="/course/google" className="btn btn-outline-primary btn-lg">
              ...
              <div className="col-md-6">
                <article className="card h-100 border-0 shadow-sm">
                  <div className="card-body">
                    ...
                    <Link href="/course/facebook" className="btn btn-success w-100">
              ...
              <div className="col-md-6">
                <article className="card h-100 border-0 shadow-sm">
                  <div className="card-body">
                    ...
                    <Link href="/course/google" className="btn btn-primary w-100">
