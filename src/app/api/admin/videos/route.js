...
/**
 * ✅ ผ่อนกฎ slug ให้สอดคล้องกับการใช้งานจริง
 * - อนุญาตไทย/อังกฤษ/ตัวเลข/-,_,/
 * - ถ้ามี space จะถูกแทนด้วย "-" อัตโนมัติ
 */
function normalizeSlug(slug = "") {
  ...
  // กันอักขระที่ไม่ต้องการแบบ “ค่อยๆ เอาออก”
  // (ถ้าคุณอยากให้รองรับ % หรือ . เพิ่มในชุดนี้ได้)
...
function validateVideo(video) {
  ...
  // ✅ ให้ตรงกับหน้า Admin: transcript/faq ต้องมีจริง
    ...
    return json(
      {
        ...
        errors,
        // ✅ ช่วย debug ว่าฝั่ง server เห็นอะไรจริง
        received: {
          slug: incoming.slug,
