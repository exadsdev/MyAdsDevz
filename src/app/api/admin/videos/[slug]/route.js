// app/api/admin/videos/[slug]/route.js
...
function safeSlugParam(params) {
    ...
    // Next.js มัก decode ให้แล้ว แต่บางเคสอาจยังเป็น %E0... อยู่
    // เลยพยายาม decode แบบปลอดภัย + กัน double decode
    ...
    // decode รอบสอง (กันกรณี encode ซ้อน)
    try {
        if (/%[0-9A-Fa-f]{2}/.test(s)) s = decodeURIComponent(s);
    } catch { }
